...
const ProviderSubscriptionPlan = mongoose.model('ProviderSubscriptionPlan', providerSubscriptionPlanSchema);
...
const updatePlan = async (input) => {
    ...
    let updatedPlan = await ProviderSubscriptionPlan.findByIdAndUpdate(id, body, {new: true})
